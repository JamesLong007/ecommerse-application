...
describe('Invoice e2e test', () => {
  ...
  it('should load create Invoice page', async () => {
    ...
    expect(await invoiceUpdatePage.getPageTitle().getAttribute('id')).to.match(
      /storeApp.ecommerseApplicationInvoice.home.createOrEditLabel/
    );
  ...
  it('should delete last Invoice', async () => {
    ...
    expect(await invoiceDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/storeApp.ecommerseApplicationInvoice.delete.question/);
