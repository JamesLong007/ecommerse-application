...
describe('ProductOrder e2e test', () => {
  ...
  it('should load create ProductOrder page', async () => {
    ...
    expect(await productOrderUpdatePage.getPageTitle().getAttribute('id')).to.match(
      /storeApp.ecommerseApplicationProductOrder.home.createOrEditLabel/
    );
  ...
  it('should delete last ProductOrder', async () => {
    ...
    expect(await productOrderDeleteDialog.getDialogTitle().getAttribute('id')).to.match(
      /storeApp.ecommerseApplicationProductOrder.delete.question/
    );
