  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="storeApp.ecommerseApplicationCustomer.delete.question">
          <Translate contentKey="storeApp.ecommerseApplicationCustomer.delete.question" interpolate={{ id: customerEntity.id }}>
