    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="storeApp.ecommerseApplicationCustomer.home.createOrEditLabel">
              <Translate contentKey="storeApp.ecommerseApplicationCustomer.home.createOrEditLabel">Create or edit a Customer</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : customerEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="genderLabel" for="customer-gender">
                    <Translate contentKey="storeApp.ecommerseApplicationCustomer.gender">Gender</Translate>
                  </Label>
                  <AvInput
                    id="customer-gender"
                    type="select"
                ...
                <AvGroup>
                  <Label id="emailLabel" for="customer-email">
                    <Translate contentKey="storeApp.ecommerseApplicationCustomer.email">Email</Translate>
                  </Label>
                  <AvField
                    id="customer-email"
                    type="text"
                ...
                <AvGroup>
                  <Label id="phoneLabel" for="customer-phone">
                    <Translate contentKey="storeApp.ecommerseApplicationCustomer.phone">Phone</Translate>
                  </Label>
                  <AvField
                    id="customer-phone"
                    type="text"
                ...
                <AvGroup>
                  <Label id="cityLabel" for="customer-city">
                    <Translate contentKey="storeApp.ecommerseApplicationCustomer.city">City</Translate>
                  </Label>
                  <AvField
                    id="customer-city"
                    type="text"
                ...
                <AvGroup>
                  <Label for="customer-user">
                    <Translate contentKey="storeApp.ecommerseApplicationCustomer.user">User</Translate>
                  </Label>
                  <AvInput
                    id="customer-user"
                    type="select"
