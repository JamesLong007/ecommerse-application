    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="storeApp.ecommerseApplicationInvoice.home.createOrEditLabel">
              <Translate contentKey="storeApp.ecommerseApplicationInvoice.home.createOrEditLabel">Create or edit a Invoice</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : invoiceEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="codeLabel" for="invoice-code">
                    <Translate contentKey="storeApp.ecommerseApplicationInvoice.code">Code</Translate>
                  </Label>
                  <AvField
                    id="invoice-code"
                    type="text"
                ...
                <AvGroup>
                  <Label id="dateLabel" for="invoice-date">
                    <Translate contentKey="storeApp.ecommerseApplicationInvoice.date">Date</Translate>
                  </Label>
                  <AvInput
                    id="invoice-date"
                    type="datetime-local"
                ...
                <AvGroup>
                  <Label id="detailsLabel" for="invoice-details">
                    <Translate contentKey="storeApp.ecommerseApplicationInvoice.details">Details</Translate>
                  </Label>
                  <AvField id="invoice-details" type="text" name="details" />
                </AvGroup>
                <AvGroup>
                  <Label id="statusLabel" for="invoice-status">
                    <Translate contentKey="storeApp.ecommerseApplicationInvoice.status">Status</Translate>
                  </Label>
                  <AvInput
                    id="invoice-status"
                    type="select"
