    ...
    return (
      <div>
        <h2 id="invoice-heading">
          <Translate contentKey="storeApp.ecommerseApplicationInvoice.home.title">Invoices</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="storeApp.ecommerseApplicationInvoice.home.createLabel">Create a new Invoice</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {invoiceList && invoiceList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('code')}>
                    <Translate contentKey="storeApp.ecommerseApplicationInvoice.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('date')}>
                    <Translate contentKey="storeApp.ecommerseApplicationInvoice.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('details')}>
                    <Translate contentKey="storeApp.ecommerseApplicationInvoice.details">Details</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('status')}>
                    <Translate contentKey="storeApp.ecommerseApplicationInvoice.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('paymentMethod')}>
                    <Translate contentKey="storeApp.ecommerseApplicationInvoice.paymentMethod">Payment Method</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('paymentDate')}>
                    <Translate contentKey="storeApp.ecommerseApplicationInvoice.paymentDate">Payment Date</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('paymentAmount')}>
                    <Translate contentKey="storeApp.ecommerseApplicationInvoice.paymentAmount">Payment Amount</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="storeApp.ecommerseApplicationInvoice.home.notFound">No Invoices found</Translate>
            </div>
          )}
        </div>
