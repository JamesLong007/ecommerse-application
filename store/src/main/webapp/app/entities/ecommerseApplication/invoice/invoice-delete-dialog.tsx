  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="storeApp.ecommerseApplicationInvoice.delete.question">
          <Translate contentKey="storeApp.ecommerseApplicationInvoice.delete.question" interpolate={{ id: invoiceEntity.id }}>
