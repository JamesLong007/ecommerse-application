...
import { getEntities as getInvoices } from 'app/entities/ecommerseApplication/invoice/invoice.reducer';
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="storeApp.ecommerseApplicationShipment.home.createOrEditLabel">
              <Translate contentKey="storeApp.ecommerseApplicationShipment.home.createOrEditLabel">Create or edit a Shipment</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : shipmentEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="dateLabel" for="shipment-date">
                    <Translate contentKey="storeApp.ecommerseApplicationShipment.date">Date</Translate>
                  </Label>
                  <AvInput
                    id="shipment-date"
                    type="datetime-local"
