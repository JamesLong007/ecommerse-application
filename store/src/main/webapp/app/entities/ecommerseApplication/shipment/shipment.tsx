...
import { IShipment } from 'app/shared/model/ecommerseApplication/shipment.model';
// tslint:disable-next-line:no-unused-variable
    ...
    return (
      <div>
        <h2 id="shipment-heading">
          <Translate contentKey="storeApp.ecommerseApplicationShipment.home.title">Shipments</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="storeApp.ecommerseApplicationShipment.home.createLabel">Create a new Shipment</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {shipmentList && shipmentList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('trackingCode')}>
                    <Translate contentKey="storeApp.ecommerseApplicationShipment.trackingCode">Tracking Code</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('date')}>
                    <Translate contentKey="storeApp.ecommerseApplicationShipment.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('details')}>
                    <Translate contentKey="storeApp.ecommerseApplicationShipment.details">Details</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="storeApp.ecommerseApplicationShipment.invoice">Invoice</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="storeApp.ecommerseApplicationShipment.home.notFound">No Shipments found</Translate>
            </div>
          )}
        </div>
