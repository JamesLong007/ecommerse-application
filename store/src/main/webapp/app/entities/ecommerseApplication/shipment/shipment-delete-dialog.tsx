  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="storeApp.ecommerseApplicationShipment.delete.question">
          <Translate contentKey="storeApp.ecommerseApplicationShipment.delete.question" interpolate={{ id: shipmentEntity.id }}>
