  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="storeApp.ecommerseApplicationOrderItem.delete.question">
          <Translate contentKey="storeApp.ecommerseApplicationOrderItem.delete.question" interpolate={{ id: orderItemEntity.id }}>
