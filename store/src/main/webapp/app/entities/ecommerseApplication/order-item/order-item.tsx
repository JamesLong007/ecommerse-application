    ...
    return (
      <div>
        <h2 id="order-item-heading">
          <Translate contentKey="storeApp.ecommerseApplicationOrderItem.home.title">Order Items</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="storeApp.ecommerseApplicationOrderItem.home.createLabel">Create a new Order Item</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {orderItemList && orderItemList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('status')}>
                    <Translate contentKey="storeApp.ecommerseApplicationOrderItem.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                  ...
                  <th>
                    <Translate contentKey="storeApp.ecommerseApplicationOrderItem.order">Order</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="storeApp.ecommerseApplicationOrderItem.home.notFound">No Order Items found</Translate>
            </div>
          )}
        </div>
