...
import { getEntities as getProducts } from 'app/entities/ecommerseApplication/product/product.reducer';
import { IProductOrder } from 'app/shared/model/ecommerseApplication/product-order.model';
import { getEntities as getProductOrders } from 'app/entities/ecommerseApplication/product-order/product-order.reducer';
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="storeApp.ecommerseApplicationOrderItem.home.createOrEditLabel">
              <Translate contentKey="storeApp.ecommerseApplicationOrderItem.home.createOrEditLabel">Create or edit a OrderItem</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : orderItemEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="quantityLabel" for="order-item-quantity">
                    <Translate contentKey="storeApp.ecommerseApplicationOrderItem.quantity">Quantity</Translate>
                  </Label>
                  <AvField
                ...
                <AvGroup>
                  <Label id="totalPriceLabel" for="order-item-totalPrice">
                    <Translate contentKey="storeApp.ecommerseApplicationOrderItem.totalPrice">Total Price</Translate>
                  </Label>
                  <AvField
                ...
                <AvGroup>
                  <Label id="statusLabel" for="order-item-status">
                    <Translate contentKey="storeApp.ecommerseApplicationOrderItem.status">Status</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label for="order-item-product">
                    <Translate contentKey="storeApp.ecommerseApplicationOrderItem.product">Product</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label for="order-item-order">
                    <Translate contentKey="storeApp.ecommerseApplicationOrderItem.order">Order</Translate>
                  </Label>
                  <AvInput
                    id="order-item-order"
                    type="select"
