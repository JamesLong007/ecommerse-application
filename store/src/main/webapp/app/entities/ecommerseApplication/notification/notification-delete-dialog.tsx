  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="storeApp.ecommerseApplicationNotification.delete.question">
          <Translate contentKey="storeApp.ecommerseApplicationNotification.delete.question" interpolate={{ id: notificationEntity.id }}>
