    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="storeApp.ecommerseApplicationNotification.home.createOrEditLabel">
              <Translate contentKey="storeApp.ecommerseApplicationNotification.home.createOrEditLabel">
