    ...
    return (
      <div>
        <h2 id="product-category-heading">
          <Translate contentKey="storeApp.ecommerseApplicationProductCategory.home.title">Product Categories</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="storeApp.ecommerseApplicationProductCategory.home.createLabel">Create a new Product Category</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {productCategoryList && productCategoryList.length > 0 ? (
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="storeApp.ecommerseApplicationProductCategory.name">Name</Translate>
                  </th>
                  <th>
                    <Translate contentKey="storeApp.ecommerseApplicationProductCategory.description">Description</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="storeApp.ecommerseApplicationProductCategory.home.notFound">No Product Categories found</Translate>
            </div>
          )}
        </div>
      </div>
