    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="storeApp.ecommerseApplicationProductCategory.home.createOrEditLabel">
              <Translate contentKey="storeApp.ecommerseApplicationProductCategory.home.createOrEditLabel">
