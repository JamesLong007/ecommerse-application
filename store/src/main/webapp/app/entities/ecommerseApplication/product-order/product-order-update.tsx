    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="storeApp.ecommerseApplicationProductOrder.home.createOrEditLabel">
              <Translate contentKey="storeApp.ecommerseApplicationProductOrder.home.createOrEditLabel">
              ...
              <AvForm model={isNew ? {} : productOrderEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="codeLabel" for="product-order-code">
                    <Translate contentKey="storeApp.ecommerseApplicationProductOrder.code">Code</Translate>
                  </Label>
                  <AvField
