    ...
    return (
      <div>
        <h2 id="product-order-heading">
          <Translate contentKey="storeApp.ecommerseApplicationProductOrder.home.title">Product Orders</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="storeApp.ecommerseApplicationProductOrder.home.createLabel">Create a new Product Order</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {productOrderList && productOrderList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('placedDate')}>
                    <Translate contentKey="storeApp.ecommerseApplicationProductOrder.placedDate">Placed Date</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('status')}>
                    <Translate contentKey="storeApp.ecommerseApplicationProductOrder.status">Status</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('code')}>
                    <Translate contentKey="storeApp.ecommerseApplicationProductOrder.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('invoiceId')}>
                    <Translate contentKey="storeApp.ecommerseApplicationProductOrder.invoiceId">Invoice Id</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('customer')}>
                    <Translate contentKey="storeApp.ecommerseApplicationProductOrder.customer">Customer</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="storeApp.ecommerseApplicationProductOrder.home.notFound">No Product Orders found</Translate>
            </div>
          )}
        </div>
