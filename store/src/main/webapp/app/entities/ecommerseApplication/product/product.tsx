    ...
    return (
      <div>
        <h2 id="product-heading">
          <Translate contentKey="storeApp.ecommerseApplicationProduct.home.title">Products</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="storeApp.ecommerseApplicationProduct.home.createLabel">Create a new Product</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {productList && productList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('name')}>
                    <Translate contentKey="storeApp.ecommerseApplicationProduct.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('description')}>
                    <Translate contentKey="storeApp.ecommerseApplicationProduct.description">Description</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('price')}>
                    <Translate contentKey="storeApp.ecommerseApplicationProduct.price">Price</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('size')}>
                    <Translate contentKey="storeApp.ecommerseApplicationProduct.size">Size</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('image')}>
                    <Translate contentKey="storeApp.ecommerseApplicationProduct.image">Image</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="storeApp.ecommerseApplicationProduct.productCategory">Product Category</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="storeApp.ecommerseApplicationProduct.home.notFound">No Products found</Translate>
            </div>
          )}
        </div>
