...
import { IProductCategory } from 'app/shared/model/ecommerseApplication/product-category.model';
import { getEntities as getProductCategories } from 'app/entities/ecommerseApplication/product-category/product-category.reducer';
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="storeApp.ecommerseApplicationProduct.home.createOrEditLabel">
              <Translate contentKey="storeApp.ecommerseApplicationProduct.home.createOrEditLabel">Create or edit a Product</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : productEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="nameLabel" for="product-name">
                    <Translate contentKey="storeApp.ecommerseApplicationProduct.name">Name</Translate>
                  </Label>
                  <AvField
                    id="product-name"
                    type="text"
                ...
                <AvGroup>
                  <Label id="priceLabel" for="product-price">
                    <Translate contentKey="storeApp.ecommerseApplicationProduct.price">Price</Translate>
                  </Label>
                  <AvField
                    id="product-price"
                    type="text"
                ...
                <AvGroup>
                  <Label id="sizeLabel" for="product-size">
                    <Translate contentKey="storeApp.ecommerseApplicationProduct.size">Size</Translate>
                  </Label>
                  <AvInput
                    id="product-size"
                    type="select"
                ...
                <AvGroup>
                  <AvGroup>
                    <Label id="imageLabel" for="image">
                      <Translate contentKey="storeApp.ecommerseApplicationProduct.image">Image</Translate>
                    </Label>
                    <br />
                    {image ? (
                      <div>
