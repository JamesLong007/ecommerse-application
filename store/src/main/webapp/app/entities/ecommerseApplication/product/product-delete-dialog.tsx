  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="storeApp.ecommerseApplicationProduct.delete.question">
          <Translate contentKey="storeApp.ecommerseApplicationProduct.delete.question" interpolate={{ id: productEntity.id }}>
